...
function initConsole() {
	...
	function processInput(input) {
		commands = {
			...
			'contact': '<span class="blue">&nbsp;Twitter: &nbsp;<a href="https://twitter.com/metrak1bear" target="_blank">@metrak1bear</a></span><br><span class="red">&nbsp;Email: &nbsp;&nbsp;&nbsp;<a href="mailto:artem.karapetyan95@gmail.com">Gmail</a></span><br><span class="orange">&nbsp;Resume: &nbsp;&nbsp;<a href="Artem_Karapetyan_RESUME.pdf"&nbsp; tarimplementationget="_blank">Resume</a></span> <br><span class="violet">&nbsp;Linkedin:&nbsp;<a href="https://www.linkedin.com/pub/artem-karapetyan/53/83/143" target="_blank">Artem Karapetyan</a></span> <br><span class="yellow">&nbsp;Github: &nbsp;&nbsp;<a href="https://github.com/ArtemKarapetyan" target="_blank">ArtemKarapetyan</a></span> <br>',
			'bio': "About Artem:<br><br>Welcome to Artem Karapetyan's website. I am a Computer Science and Business Professional, I recieved my degree in Computer Science and Information Security from John Jay College of Criminal Justice. I am currently employeed by Raj Technologies Inc. (formally Infosys International Inc.) working on an InforEAM implementation for the MTA LIRR.",
